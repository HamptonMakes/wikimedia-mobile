...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "Rakefile", "TODO", "Generators", "lib/generators", "lib/generators/data_mapper_migration.rb", "lib/generators/data_mapper_model.rb", "lib/generators/data_mapper_resource_controller.rb", "lib/generators/templates", "lib/generators/templates/migration.rb", "lib/generators/templates/model.rb", "lib/generators/templates/model_migration.rb", "lib/generators/templates/resource_controller.rb", "lib/generators/templates/views", "lib/generators/templates/views/edit.html.erb", "lib/generators/templates/views/index.html.erb", "lib/generators/templates/views/new.html.erb", "lib/generators/templates/views/show.html.erb", "lib/merb", "lib/merb/orms", "lib/merb/orms/data_mapper", "lib/merb/orms/data_mapper/connection.rb", "lib/merb/orms/data_mapper/database.yml.sample", "lib/merb/session", "lib/merb/session/data_mapper_session.rb", "lib/merb_datamapper", "lib/merb_datamapper/merbtasks.rb", "lib/merb_datamapper/version.rb", "lib/merb_datamapper.rb"]
  s.has_rdoc = true
