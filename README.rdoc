...
7) Browse to http://en.m.wikitest.org:4000 in Safari (most useful as webkit is the main target)

8) Install Palm Pre, Android, and iPhone Simulators
...
** Any method_missing that Device receives is looked up in the format specfication
...
** Changes in the search box and CSS fiels are the most different between formats
